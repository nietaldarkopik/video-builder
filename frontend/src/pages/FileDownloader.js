...
import { decode64, parseParams } from '../helpers/utils';
...
const FileDownloader = () => {
  ...
  searchData = parseParams(searchData)
  searchData = (searchData.path)?decode64(searchData.path):''
  const [url, setUrl] = useState(searchData);
            ...
            <div className="row justify-content-start align-items-start g-2">
              <div className="col-md-12">
                <div className="mb-3">
                  ...
                  <textarea className="form-control" name="" id="urlVideo" rows="3" defaultValue={url} />
                </div>
              </div>
              <div className="col-md-12">
                <div className="mb-3">
